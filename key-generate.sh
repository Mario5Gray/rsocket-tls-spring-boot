...
# under the License.
#
DESTINATION_BROKER=src/main/resources/keystore
DESTINATION_CLIENT=src/main/resources/keystore

mkdir -p $DESTINATION_BROKER
mkdir -p $DESTINATION_CLIENT
...
cp client.truststore.jks broker.truststore.jks client.keystore.jks broker.keystore.jks $SCRIPT_DIR/$DESTINATION_BROKER
cp client.truststore.jks broker.truststore.jks client.keystore.jks broker.keystore.jks $SCRIPT_DIR/$DESTINATION_CLIENT
